...
class Twitter:
    ...
    def getNewsFeed(self, userId: int) -> List[int]:
        ...
        while tweet_heap and len(feed) < 10:
            ...
            vendorId, cur_vendors_tweet_idx = newest_tweet[1]
            if cur_vendors_tweet_idx == 0:
                continue
            next_tweet = self.account_to_tweets[vendorId][cur_vendors_tweet_idx - 1]
            heapq.heappush(tweet_heap, (next_tweet, (vendorId, cur_vendors_tweet_idx - 1)))
